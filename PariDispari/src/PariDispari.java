...
/**
 *Questo programma distingue i numeri pari dai numeri dispari utilizzando i thread.
 * per poi mostrarli a video.
...
public class PariDispari extends Thread{
  ...
  private int ritardo = 500;
   ...
   /**
   * @param finale numero di volte che viene effettuato un output
